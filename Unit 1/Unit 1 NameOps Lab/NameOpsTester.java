public class NameOpsTester {
        public static void main(String[] args) {
                ...
                test1 = NameOps.printMethodCall(method, name1) +
                                NameOps.indexOfFirstSpace(name1);
                test2 = NameOps.printMethodCall(method, name2) +
                                NameOps.indexOfFirstSpace(name2);
                test3 = NameOps.printMethodCall(method, name3) +
                                NameOps.indexOfFirstSpace(name3);
                ...
                test1 = NameOps.printMethodCall(method, name1) +
                                NameOps.indexOfSecondSpace(name1);
                test2 = NameOps.printMethodCall(method, name2) +
                                NameOps.indexOfSecondSpace(name2);
                test3 = NameOps.printMethodCall(method, name3) +
                                NameOps.indexOfSecondSpace(name3);
                System.out.println(test1); // -1
                ...
                test1 = NameOps.printMethodCall(method, name1) +
                                NameOps.findFirstName(name1);
                test2 = NameOps.printMethodCall(method, name2) +
                                NameOps.findFirstName(name2);
                test3 = NameOps.printMethodCall(method, name3) +
                                NameOps.findFirstName(name3);
                ...
                test1 = NameOps.printMethodCall(method, name1) +
                                NameOps.findMiddleName(name1);
                test2 = NameOps.printMethodCall(method, name2) +
                                NameOps.findMiddleName(name2);
                test3 = NameOps.printMethodCall(method, name3) +
                                NameOps.findMiddleName(name3);
                System.out.println(test1); //
